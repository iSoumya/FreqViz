...
var songName = document.getElementById("artist");
...
file.onchange = function(){
    ...
    songName.parentElement.innerHTML = this.files[0].name.replace(".mp3","");
    openFullscreen();
    file.hidden = true;
    audio.load();
    ...
    console.log("Ready");
        ...
        if(!analyser){
          ...
          gainNode = gainNode != undefined ? gainNode : actx.createMediaElementSource(audio);
...
document.getElementById("btn-play-pause").firstElementChild.classList.remove('fa-pause');
document.getElementById("btn-play-pause").firstElementChild.classList.add('fa-play');
...
function pause() {
  ...
  audio.pause();
  document.getElementById("btn-play-pause").firstElementChild.classList.remove('fa-play');
  document.getElementById("btn-play-pause").firstElementChild.classList.add('fa-pause');
